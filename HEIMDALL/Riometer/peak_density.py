...
# Create the plot of median electron density vs time
plt.figure(figsize=(12, 8))
plt.plot(times, median_ne, 'b-', label='Median Electron Density')
...
plt.title('Median Electron Density (90-150 km) - March 3-4, 2025')
plt.yscale('log')
plt.grid(True)
plt.legend()
